...
### Configure Git remotes <small>(Scale Plan)</small>

!!! info "Scale Plan required"

    This step is only required for Scale Plan users. If you're using the Discover or MVP Plan, you can skip this section.
...
### Keep your project up to date <small>(Scale Plan)</small>
